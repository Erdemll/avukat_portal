                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            @can('delete', $event)
                                <details class="relative">
                                    <summary class="cursor-pointer list-none rounded-lg border border-red-200 bg-white px-3 py-2 text-sm font-semibold text-red-700 hover:bg-red-50">Olayı Sil</summary>
                                    <div class="absolute right-0 z-20 mt-2 w-72 rounded-xl border border-red-200 bg-white p-4 shadow-xl">
                                        <p class="text-sm text-slate-700">Bu olay ve olay belgeleri arşivlenecek.</p>
                                        <form class="mt-3" method="POST" action="{{ route('events.destroy', $event) }}">
                                            @csrf
                                            @method('DELETE')
